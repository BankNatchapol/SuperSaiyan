...
echo
echo "✓ super-board installed."
if [ "${SUPER_BOARD_EMBEDDED_INSTALL:-false}" != "true" ]; then
  echo "  1. run /super-board onboard"
  echo "  2. add clear GitHub issues to Ready"
  echo "  3. run /super-board lint"
  echo "  4. run /super-board run <slug>"
  echo
