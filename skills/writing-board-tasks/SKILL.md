...
- Heading present and empty, `None`, or every item records a recommendation/resolution: proceed. A decision log belongs under a heading outside that set (for example `## Resolved judgment calls`).
